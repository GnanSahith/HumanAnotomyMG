export default {
  "1": [
    {
      "q": "1. What can make what is today a renewable resource non-renewable tomorrow? Describe some actions that can prevent this from happening.",
      "a": "wer:\nIf renewable resources like forests or water are used faster than they can regenerate, they may become non-renewable. To prevent this, resources should be used judiciously, allowing time for natural restoration and following sustainable practices such as controlled usage, replanting, and conservation."
    },
    {
    ...
    },
    {
      ...
      "a": "wer:\nRenewable resources are those that can replenish naturally over time, like sunlight and water. Non-renewable resources, such as coal and petroleum, cannot be replaced once used. To ensure continued availability, people must use renewable resources carefully, allow time for regeneration, and avoid overexploitation. Examples: solar energy, timber (with sustainable forestry practices)."
    },
    {
      "q": "4. Identify cultural practices in your home and neighbourhood that point to mindfulness in the use of natural resources.",
      "a": "wer:\nExamples include using traditional vessels made of clay instead of plastic, celebrating festivals with eco-friendly materials, cleaning water bodies during festivals, reusing resources, and practicing rituals that respect trees and water sources, all reflecting mindfulness towards resource usage."
    },
    {
      "q": "5. What are some considerations to keep in mind in the production of goods for our current use?",
      "a": "wer:\nImportant considerations include minimizing pollution, sustainable extraction of resources, choosing renewable or recyclable materials, reducing waste, conserving energy and water, and ensuring minimal environmental impact for the benefit of present and future generations.\nUnderstanding Natural Resources and Their Use\nMastering\nNatural Resources and Their Use\nis essential for Class 8 Social Science. This NCERT chapter covers renewable and non-renewable resources, sustainable practices, and the impacts of overexploitation, providing a solid foundation for board and competitive exams.\nStudying with\nNCERT solutions Class 8 Social Science Chapter 1\nhelps students understand key differences between resources and the need for responsible usage. Regular revision of important concepts like ecosystem functions boosts retention and exam confidence.\nFocus on examples of\nsustainable resource use\nand relate them to real-life scenarios. Practicing chapter-wise solutions ensures clarity and helps you score higher marks in the Social Science exam for 2026-27."
    }
  ],
  "2": [
    {
      ...
      "a": "wer:\nBoth the Delhi Sultanate and the Mughals aimed to expand and consolidate their empires. The Sultanate relied heavily on military conquests, frequent plundering, and imposition of taxes like jizya. The Mughals, especially under Akbar, combined military campaigns with alliances, religious tolerance (sulh-i-kul), and administrative innovations such as the mansabdari system. While successions in the Sultanate were violent and unstable, the Mughal court emphasized a more centralized and enduring administration, and promoted cultural integration."
    },
    {
    ...
    },
    {
      ...
      "a": "wer:\nDearest Friend, Life at court is dazzling. Emperor Akbar generously welcomes people of all faiths; debates on religion and philosophy are encouraged. Traders bring silk, horses, and spices; roads and cities flourish. New poems and paintings bring together traditions from across India, creating a thriving cultural atmosphere. Society is changing, but everyone is eager for learning and progress."
    },
    {
    ...
    },
    {
      ...
      "a": "wer:\nHad Vijayanagara won at Talikota, their empire might have continued to be the dominant power in south India. Cultural centers like Hampi would have flourished longer; temple-building and arts would grow. The spread of regional languages and administrative systems could have influenced neighboring states, and resistance to northern powers might have been stronger, shaping a unique southern identity."
    },
    {
  ...
  "3": [
    {
      "q": "1. Analyse how geography (particularly mountains and coastlines) guided Maratha military strategy and state formation.",
      "a": "wer:\nThe Marathas made strategic use of the Western Ghats and the Konkan coast. Forts atop mountains provided natural defence and surveillance points, while the rugged terrain favored their guerrilla tactics. The long coastline enabled them to develop a navy, defend against maritime threats, and control regional trade routes."
    },
    {
  ...
  "6": [
    ...
    {
      "q": "2. Debates and discussions where different parties scrutinise Bills and policies.",
      "a": "Detailed solution available."
    },
    {
      "q": "3. Parliamentary Committees that examine Bills, budgets, and implementation in detail and invite expert/stakeholder inputs.",
      "a": "Detailed solution available."
    },
    {
  ...
  "7": [
    ...
    },
    {
      ...
      "a": "wer:\nTechnology enables\nanytime, anywhere learning\nvia online courses, videos, virtual labs, and interactive apps. Learners follow\npersonalised pathways\nwith adaptive quizzes and rapid feedback, join\ncommunities and mentoring\n, and access the most\nup-to-date content\n. Micro-credentials and project platforms help people\nshowcase real work\nand keep skills aligned with job-market needs."
    },
    {
      "q": "4. A skill is something you learn and practice to get better. It helps you do things well, like playing a sport, creative writing, solving math problems, cooking, or even communicating well with people. If you could learn one skill today, what would it be and why?",
    ...
    {
      "q": "6. Can technology replace other factors like labour? Is this good or bad? Support your answer with the help of an example.",
      "a": "wer:\nTechnology can\nsubstitute\nfor some tasks (e.g., automated assembly lines) but typically\ncomplements\nlabour by lifting productivity and safety. The impact is mixed: some roles shrink, while new jobs arise in maintenance, programming, design, and quality control.\nExample:\nIn manufacturing,\nrobotic welding\nreduces errors and speeds production, yet technicians are needed for setup, monitoring, and repairs."
    },
    {
    ...
    },
    {
      ...
      "a": "wer:\nInputs include\nland/premises\n(factory/workshop),\ncapital\n(forming machines, polishing units, moulds, packaging tools),\nraw materials\n(food-grade stainless steel, caps, seals, coatings),\nlabour\n(operators, quality controllers, sales),\ntechnology\n(design specs, safety standards), and\nentrepreneurship\nto coordinate procurement, production, and sales.\nProcurement:\nsupplier contracts for steel and components; equipment vendors for machinery; hiring via job boards and training institutes.\nIf a factor is missing:\nsupply gaps or machine downtime can halt production, reduce quality, and cause missed deliveries."
    },
    {
      "q": "9. Interview an entrepreneur or founder to understand their motivation to start a business and the opportunities and challenges they saw. You can work in pairs to create a questionnaire to collect the information and share what you have learned in a report.",
  ...
  "12": [
    ...
    },
    {
      ...
      "a": "The Planning Commission was established to assist in the establishment of appropriate policies for India's economic development."
    },
    {
      "q": "3. Fill in the blanks:\nSubjects that were placed on the Union List were ________ , _______ and ______.",
      "a": "Subjects that were placed on the Union List were\ntaxes\n,\ndefence\nand\nforeign affairs\n.\nSubjects on the Concurrent List were __________ and ___________.\nAns:\nSubjects on the Concurrent List were\nforest\nand\nagriculture\n.\nEconomic planning by which both the state and the private sector played a role in development was called a ____________ model.\nAns:\nEconomic planning by which both the state and the private sector played a role in development was called a\nmixed-economy\nmodel.\nThe death of ____________ sparked off such violent protests that the government was forced to give in to the demand for the linguistic state of Andhra.\nAns:\nThe death of\nPotti Sriramulu\nsparked off such violent protests that the government was forced to give in to the demand for the linguistic state of Andhra."
    },
    {
