export default {
  "1": [
    {
      "q": "1. Name the parts of an angiosperm flower in which the development of male and female gametophytes takes place.",
      "a": "In pollen sacs of the anther, male gametophytes (microgametogenesis) develop up to the 2-celled stage. The nucellus of an ovule is where the gametophyte develops (megagametogenesis)."
    },
    {
  ...
  "3": [
    ...
    },
    {
      ...
      "a": "The following are some strategies for assisting infertile couples in having children:\nBaby-in-a-Tube Program:\nThe ova from the wife/donor (female) and the sperms from the husband/donor (male) are collected and induced to form a zygote in the laboratory under simulated conditions. The zygote created is subsequently put into a typical female's fallopian tube.\nGamete Intra Fallopian Transfer (GIFT):\nThe transfer of an ovum from a donor into the fallopian tube of another female who cannot produce eggs but can offer a fertile environment.\nZygote IntraFallopian Transfer(ZIFT):\nThe egg arrives after the blastomere stage and is transferred to the uterus for further stages.\nIntracytoplasmic Sperm injection (ICSI):\nA sperm is injected directly into the ovum.\nArtificial Insemination (AI):\nSemen is obtained from the husband or a healthy donor and artificially implanted into the female's vaginal or uterine cavity."
    },
    {
      "q": "10. What are the Measures One Has To Take To Prevent Contracting STDs?",
      "a": "To avoid catching STDs, take the following precautions:\nAvoid intercourse with unknown or many partners.\nWhen coitus occurs, always use condoms.\nIf in doubt, seek the advice of a skilled doctor for early detection and thorough treatment of disease is found."
    },
    {
      "q": "11. State True/False With Explanation\n(a)\nAbortions Could Happen Spontaneously Too.\n(True/False)\n(b)\nInfertility is defined as the inability to produce viable offspring and is always due to abnormalities/defects in the female partner.\n(True/False)\n(c)\nComplete lactation could help as a natural method of contraception.\n(True/False)\n(d) Creating awareness about sex related aspects is an effective method to improve the reproductive health of people.\n(True/False)",
      "a": "(a)\nTrue,\nabortions can occur spontaneously due to a variety of internal reasons.\n(b)\nFalse.\nInfertility is described as a couple's inability to have a child following unprotected sexual cohabitation, and it can be caused by abnormalities/defects in either the male or female or both.\n(c)\nFalse,\nBreastfeeding is a natural means of contraception, however, it is only effective for the duration of the lactation period, which lasts six months after parturition.\n(d)\nTrue,\nIncreasing sex-related understanding gives important information regarding reproductive health."
    },
    {
      ...
      "a": "(a)\nSurgical contraception prevents the flow of gametes during sexual activity.\n(b)\nThere is no cure for all sexually transmitted diseases.\n(c)\nOral contraceptives are particularly common among metropolitan women.\n(d)\nThe E.T. procedure involves transferring 8 celled embryos into the fallopian tube and more than 8 celled embryos into the uterus.\nTopics Covered in Class 12 Biology Chapter 3 Reproductive Health\nS.No.\nClass 12 Biology Chapter 3 Topics Covered\n1\nReproductive Health: Problems and Strategies\n2\nPopulation Explosion and Birth Control\n3\nMedical Termination and Pregnancy\n4\nSexually Transmitted Diseases\n5\nInfertility\nBenefits\u00a0 of NCERT Solutions For Chapter 3 Reproductive Health Class 12 PDF\nComprehensive Coverage of Key Concepts\n: The solutions provide detailed explanations of all key concepts related to reproductive health, ensuring that students thoroughly understand the subject.\nClear Understanding of Terminology\n: Difficult terms and concepts related to reproductive health are explained clearly, making it easier for students to grasp complex topics.\nExam-Oriented Approach\n: The solutions are designed to align with the CBSE curriculum, covering important questions likely to appear in exams. This helps students focus their study efforts effectively.\nEfficient Revision Tool\n: With concise and accurate answers, the PDF serves as an excellent revision tool, allowing students to review the chapter before exams quickly.\nEnhanced Problem-Solving Skills\n: By practising with these solutions, students can develop their problem-solving skills, improving their ability to answer various questions confidently.\nSelf-Assessment\n: The solutions enable students to assess their understanding and identify areas where they need further practice, facilitating better preparation.\nTime Management\n: With well-structured solutions, students can manage their study time more efficiently, focusing on key areas without getting overwhelmed.\nImproved Academic Performance:\nThese solutions can help students improve their academic performance by providing a reliable resource to understand and master the chapter content.\nAvailability in PDF Format\n: The FREE PDF format allows students to access the solutions anytime and anywhere, making studying on the go or offline convenient.\nConfidence Building\n: Having access to accurate solutions boosts students' confidence, as they can verify their answers and ensure they are on the right track.\nImportant\u00a0 Study Materials for Chapter 3- Reproductive Health\nS.No.\nImportant Links for Biology Class 12 Chapter 3 Reproductive Health\n1\nClass 11 Reproductive Health Important Questions\n2\nClass 11 Reproductive Health Exemplar Solutions\n3\nClass 11 Reproductive Health Revision Notes\nConclusion\nThe NCERT Solutions for Biology Chapter 3 Reproductive Health Class 12 provides an invaluable resource for students studying the topic in-depth. Chapter 3, Reproductive Health Class 12 NCERT PDF, focuses on Reproductive Health, covering various aspects of reproductive health, population control, and the importance of reproductive healthcare. The solutions provide accurate answers and offer additional explanations, examples, and relevant diagrams to facilitate better comprehension of the subject matter and effectively prepare students for board exams.\nNCERT Solutions for Class 12 Biology | Other Chapter-wise Links\nBelow are the other chapter-wise links for NCERT Solutions for Class 12 Biology.\nS.No.\nOther Chapter-wise Links for NCERT Solutions Class 12 Biology\n1\nChapter 1 - Sexual Reproduction in Flowering Plants Solutions\n2\nChapter 2 - Human Reproduction Solutions\n3\nChapter 4 - Principles of Inheritance and Variation Solutions\n4\nChapter 5 - Molecular Basis of Inheritance Solutions\n5\nChapter 6 - Evolution Solutions\n6\nChapter 7 - Human Health and Disease Solutions\n7\nChapter 8 - Microbes in Human Welfare Solutions\n8\nChapter 9 - Biotechnology Principles and Processes Solutions\n9\nChapter 10 - Biotechnology and Its Applications Solutions\n10\nChapter 11 - Organisms and Populations Solutions\n11\nChapter 12 - Ecosystem Solutions\n12\nChapter 13 - Biodiversity and Conservation Solutions\nOther Related Links for Class 12 Biology\nS.No.\nImportant Links For Biology Class 12"
    },
    {
      "q": "1.\nBiology Class 12 Important Questions",
      "a": "Detailed solution available."
    },
    {
      "q": "2.\nBiology Class 12 Exemplar Solutions",
      "a": "Detailed solution available."
    },
    {
      "q": "3.\nBiology Class 12\u00a0 Revision Notes",
      "a": "Detailed solution available."
    },
    {
    ...
    {
      "q": "5.\nBiology Class 12\u00a0 PYQP",
      "a": "Detailed solution available."
    }
  ],
  "4": [
    {
      "q": "1. Mention the advantages of selecting pea plants for experiments by Mendel.",
      "a": "The pea plant (Pisum sativum) was chosen by Mendel for the following reasons:\nThe pea is an annual plant with a brief growing season. As a result, the findings can be achieved in a short amount of time.\nPea has seven distinct features with easily distinguishable traits such as tall and short stature, round and yellow seeds, and so on.\nSelf-pollination and cross-pollination are both viable options for pea propagation. Mendel was able to create pure lines as well as carry out various crosses between plants with contrasting features as a result of this.\nEach generation of the pea plant produces a great number of seeds. As a result, it can provide a vast volume of data that can be statistically more reliably analyzed, for example."
    },
    {
    ...
    {
      "q": "1. A trait that counteracts the effects of another trait, such as tallness suppressing dwarfism.",
      "a": "Detailed solution available."
    },
    {
      "q": "1. A trait that is suppressed as a result of the effect of another attribute. Dwarfness, for example, is suppressed by height.",
      "a": "Detailed solution available."
    },
    {
      "q": "2. A trait that will manifest itself even if the recessive trait is present.",
      "a": "Detailed solution available."
    },
    {
      "q": "2. A trait that only manifests when the dominant trait is absent.",
      "a": "Detailed solution available."
    },
    {
      "q": "3. A trait that manifests in both homozygous and heterozygous individuals.",
      "a": "Detailed solution available."
    },
    {
      "q": "3. A trait that can only be expressed in homozygous individuals.\n(b) Homozygous and Heterozygous",
      "a": "Homozygous\nHeterozygous"
    },
    {
      "q": "1. For a trait, a genotype is made up of alleles that are similar.\nTT\n(for tall) or\ntt\nare examples of abbreviations (for short).",
      "a": "Detailed solution available."
    },
    {
      "q": "1. For a trait, a genotype with different alleles. e.g.\nTt\n.",
      "a": "Detailed solution available."
    },
    {
      "q": "2. The person could be dominant or recessive. Individuals with the\nTT\ngenotype, for example, will be tall plants, but those with the\ntt\ngenotypes will all be short plants.",
      "a": "Detailed solution available."
    },
    {
      "q": "2. The person is usually dominant or partially dominant, but never recessive.",
      "a": "Detailed solution available."
    },
    {
      "q": "3. Individuals will only create one type of gamete.\nT\nor\nt\nfor example",
      "a": "Detailed solution available."
    },
    {
      "q": "3. The person will create two different types of gametes. Both\nT\nand\nt\ngametes, for example.\n(c) Monohybrid and Dihybrid",
      "a": "Monohybrid\nDihybrid"
    },
    {
      "q": "1. A monohybrid is a person created by crossing parents that have different features for only one character, such as height.\nTt\n(monohybrid for plant height) is an example.",
      "a": "Detailed solution available."
    },
    {
      "q": "1. A dihybrid is a person created by crossing parents who have different features for two characters, such as seed color and seed shape. RrYy (dihybrid for seed color and shape), for example.",
      "a": "Detailed solution available."
    },
    {
      "q": "2. A monohybrid cross is a cross between two parents that are homozygous for opposing character characteristics. For example, a cross between tall\nTT\nand short (S)\ntt\n.",
      "a": "Detailed solution available."
    },
    {
      "q": "2. A dihybrid cross occurs when two parents are homozygous for opposing features in two different characters, such as seed shape and seed color. A cross between RRYY (round and yellow seeds) and rryy, for example (wrinkled and green seeds).",
      "a": "Detailed solution available."
    },
    {
      "q": "3. Monohybrid cross is used to investigate the inheritance of a single character.",
      "a": "Detailed solution available."
    },
    {
      "q": "3. Dihybrid cross is used to investigate the inheritance of two characters.",
      "a": "Detailed solution available."
    },
    {
      "q": "3. A diploid organism is heterozygous for 4 loci, how many types of gametes can be produced?",
      "a": "Gene loci are locations on the chromosome where genes are found. As a result, loci and genes might be considered interchangeable. If a diploid organism is heterozygous for four loci, it will have four distinct traits: $A a, B b, C c$ and $D d$, and two gametes will be produced during meiosis, where $n$ is the number of loci. As a result, 16 different types of gametes will emerge."
    },
    {
      "q": "4. Explain the Law of Dominance using a monohybrid cross.",
      "a": "Characters are governed by discrete units that appear in pairs, known as factors, according to Mendel's Law of Dominance. One component dominates over the other in a pair of distinct factors. As a result, when two parents $(P)$ with opposing qualities are crossed, the progeny (F1) will only express one of the features. The dominant trait is the one that is expressed in the progeny and is known as the dominant trait, whereas the recessive trait is the one that is known as the recessive trait. When the $(F 1)$ generation is selfed, the recessive characteristic emerges in the next generation $(F 2)$. This suggests that the recessive feature did not vanish, but that the dominant allele reduced its expression. Using a monohybrid cross, it can be stated as follows. A monohybrid cross is a cross between two parents who are homozygous for opposing character characteristics.\nFor example, a cross between tall $T T$ and short(s) $t t$."
    },
    {
    ...
    },
    {
      ...
      "a": "When heterozygous male guinea pigs $(W w)$ with black coats are crossed with homozygous female guinea pigs $(w w)$ with white coats, we can see that the male generates two types of gametes $W$ and $w$, while the female produces only one form of gamete $w$.\nWe can see that the genotypic and phenotypic ratios in the $(F 1)$ generations are the same, i.e., $1: 1$, using the Punnett square."
    },
    {
      "q": "7. When a cross is made between tall plants with yellow seeds TtYy and tall plant with green seed TtYy, what proportions of phenotype in the offspring could be expected to be\n(a) Tall and green. (b) Dwarf and green.",
      "a": "When tall plants with yellow seeds (TtYy) are crossed with tall plants with green seeds (TtYy), The phenotypic proportion in the progeny should be three tall and green, one dwarf and green.\nTY\nTy\ntY\nty\nTY\nTTYY\nTTYy\nTtYY\nTtYy\nTy\nTTYy\nTTyy\nTtYy\nTtyy\ntY\nTtYY\nTtYy\nttyy\nttYy\nty\nTtYy\nTtyy\nttYy\nttyy\nTall and gre\u00e8n ratio is: $\\frac{3}{8}$\nDwarf and green ratio is:$\\frac{1}{8}$"
    },
    {
      ...
      "a": "When two genes are inherited together, they are referred to as linked genes, and linkage is the term used to describe this process. There will be no segregation of alleles if two genes are connected, and the alleles will be inherited together as a single gene. If two genes are connected, the phenotype of the F1 generation will solely contain parental features and no recombinants. There may be few recombinants in the case of inadequate linkage, but the proportion of parental phenotypes will be higher."
    },
    {
      "q": "9. Briefly mention the contribution of T.H. Morgan in genetics.",
      "a": "T.H. Morgan made significant contributions to genetics through his research on the fruit fly Drosophila melanogaster. The following are some of his key contributions to the science of genetics:\nHe confirmed the Chromosomal Theory of Inheritance empirically. According to this view, genes are located on chromosomes, which are inherited by daughter cells.\nHe established the presence of interconnected genes. Genes that are linked are those that are found on the same chromosome. According to the hypothesis of linkage, genes on the same chromosome are inherited together and are less likely to recombine.\nHe proved that the distance between genes on a chromosome influences the rate of recombination.\nThe closer two genes are connected, the more likely they will be passed down in the same family. The further apart two genes are on a chromosome, the more probable recombinants will develop.\nDuring meiosis, he exhibited chromosomal crossing over.\nIn the fruit fly, he demonstrated X-linked inheritance. Drosophila melanogaster is a type of Drosophila."
    },
    {
      "q": "10. What is pedigree analysis? Suggest how such an analysis can be useful.",
      "a": "Pedigree Study is a type of genetic analysis in which the inheritance of a specific gene is traced through a person's lineage. It is accomplished by the use of a pedigree chart, which is a scientific chart of ancestors produced using precise symbols to identify male, female, carrier, disease, and so on. The following are some of the benefits of pedigree analysis:\nDetermine whether the gene is homozygous or heterozygous or homozygous or heterozygous for heterozygous or homozygous or heterozygous or homozygous or heterozygous for homozy\nExamination of the gene's inheritance over successive generations of the same family.\nDetermine whether a particular genetic condition is caused by a dominant or recessive gene.\nTo look into the origins of the sickness in the family and try to figure out what caused it.\nTo determine whether or not this gene will be passed down via future generations, as well as the likelihood of this happening.\nTo provide genetic counseling to families who are at high risk for various genetic disorders such as hemophilia, sickle cell anemia, and so on."
    },
    {
      "q": "11. How is sex determined in human beings?",
      "a": "Humans have an $X Y$ sex determination pattern. Female sex chromosomes are $X X$, while male sex chromosomes are $X Y$. Females can only generate gametes with $X$ chromosomes, but men can produce gametes with both $X$ and $Y$ chromosomes.\nWhen a male $Y$ chromosome-containing gamete fertilizes with a female $-X$ chromosome-containing gamete, the result is a male fetus. When a male $X$ chromosome-containing gamete fertilizes with either a female or a male gamete, the fetus is a female."
    },
    {
      "q": "12. A child has a blood group O. If the father has a blood group A and mother\u2019s blood group B, work out the genotypes of the parents and the possible genotypes of the other offspring.",
      "a": "Human blood groups are determined by three types of alleles: $I$, $I^{B}$ and $i$. While $I^{A}, I^{B}$ are codominant, $I$ is recessive. $I^{A}$ stands for blood group $A$, and $I^{B}$ stands for blood group $B$. The $I$ allele codes for the $O$ blood group.\nThere are two possible allele combinations for a person with blood group $A$. They are: $I^{A} I^{A}$ or $I^{A} i$. There are also two possible allele combinations for a person with blood group $B$. They are: $I^{B} I^{B}$ or $I^{B} i$. The blood group $A B$ is formed when both $I^{A}$ and $I^{B}$ are present, while the blood type $O$ is formed when both are absent. Because both the father and mother have dominant alleles but the child has a recessive phenotype, the parent's dominant $A$ and $B$ alleles must be present in the heterozygous situation. This is because if the alleles were homozygous in either parent, the child would have the dominant phenotype rather than the recessive phenotype. As a result, under the preceding scenario, the other offspring could have the $A, B$ or $A B$ blood group."
    },
    {
      "q": "13. Explain the following terms with examples:\nCodominance",
      "a": "Codominance occurs when both opposing alleles of a gene pair are equally expressed. For example, in the human blood group, both $A$ and $B$ are equal prominent, and when both are present, the $A B$ blood group appears instead of either $A$ or $B$\nIncomplete dominance\nAns:\nIncomplete dominance occurs when a dominant allele does not entirely cover the effects of a recessive allele, resulting in a blending of both alleles in the organism's\nphysical appearance. It's also termed as half dominance or semi-dominance. Take, for example, the flower color of a snapdragon plant. The red flower color (R) has an imperfect dominance over the white flower color (r). When both alleles (R) are present in the same plant, (R) is unable to completely repress (r), resulting in a pink flower phenotype."
    },
    {
      "q": "14. What is point mutation? Give one example.",
      "a": "Point mutation happens when a mutation arises in a single base pair of DNA. For example, in sickle cell anemia, glutamic acid is replaced by valine in the sixth position of the beta globin chain of hemoglobin, resulting in sickle-shaped RBCs rather than biconcave RBCs."
    },
    {
      "q": "15. Who had proposed the chromosomal theory of inheritance?",
      "a": "The chromosomal hypothesis of inheritance was presented by Sutton and Boveri in 1902. This states that chromosomes serve as carriers for gene inheritance."
    },
    {
      "q": "16. Mention any two autosomal genetic disorders with their symptoms.",
      "a": "Sickle Cell Anemia -\nWhen glutamic acid is replaced by valine in the sixth position of the beta globin chain of hemoglobin due to a point mutation, the biconcave shape of hemoglobin transforms into a sickle shape. This causes a reduction in blood oxygen delivery, as well as weakness and fatigue.\nPhenylketonuria -\nPhenylketonuria is a condition in which a person lacks an enzyme that transforms amino acids and phenylalanine to tyrosine. The phenylalanine then builds up and is converted to phenyl pyruvic acid and other derivatives. Mental retardation is a symptom of this disease. They are eliminated in the urine due to inadequate renal absorption.\nTopics Covered in Class 12 Biology Chapter 4 Principles of Inheritance and Variation NCERT Solutions"
    },
    {
      "q": "1.\nCBSE Class 12 Biology Important Questions",
      "a": "Detailed solution available."
  ...
  "6": [
    {
      ...
      "a": "Adaptations to a specific environment allow organisms to survive, according to Darwin. Bacteria that are sensitive to a particular antibiotic die when they come into contact with it. Some bacteria, however, develop resistance to the antibiotic when they have favourable mutations. Bacteria resistant to these types of bacteria can persist and multiply quickly after their competition is eliminated. As a result, the number of them grows. A member of the population may also inherit genes that confer resistance to others. Thus, bacterial people everywhere become resistant to antibiotics.\n2 Find Out from Newspapers and Popular Science Articles Any Few Fossil Discoveries or Controversies About Evolution.\nAns:\nAs per the Times of India- Chimps are more intelligent than humans:\nIn an experiment, researchers found that chimpanzees had greater evolutionary flexibility than humans. The human species is unquestionably more advanced than other species. Comparing 14,000 genes between humans and chimpanzees demonstrates that we humans have been more influenced by natural selection than our ape cousins.\nNatural selection cannot explain why we have large brains and high intelligence. Chimpanzees and humans share a common ancestor, an ape, dating approximately 5 million years ago. As generations passed, their genes evolved to ensure future generations had the best chance of survival. In contrast, the findings of a US study indicate that humans possess a much lower number of positively selected genes than chimps."
    },
    {
      "q": "3. Attempt Giving a Clear Definition of the Term Species.",
      "a": "Species are populations or groups of individuals capable of interbreeding and producing viable and fertile offspring."
    },
    {
      ...
      "a": "Human evolution can be broken down into the following components:"
    },
    {
      "q": "1. Volume of the human brain",
      "a": "Detailed solution available."
    },
    {
      "q": "2. Structure of the skeleton",
      "a": "Detailed solution available."
    },
    {
      "q": "3. Posture",
    ...
    {
      "q": "4. Preferences in terms of diet",
      "a": "Detailed solution available."
    },
    {
      "q": "5. Behavioral traits\nSignificant changes in morphology occurred in the ancestors of modern humans:\n(1) Elevation and narrowing of the nose.\n(2) Chin formation.\n(3) Diminishing the brow ridges.\n(4) The face becomes flattened.\n(5) Less hair on the body.\n(6) Curvature of the vertebral column to promote upright posture.\n(7) Presence of a bowl that constitutes the pelvic girdle in support of the viscera.\n(8) Height increases.\n(9) Possessing an upright posture and moving bipedally.\n(10) The rounding of the head and the enlargement of the head.\n(11) Increase in brain size and intelligence.\n(12) Broadening of the forehead and with vertical elevation",
      "a": "Detailed solution available."
    },
    {
      "q": "5. Find Out Through the Internet and Popular Science Articles Whether Animals Other Than Man Have Self-Consciousness\n.",
      "a": "The ability to introspectively determine one's relationships to the environment and other people remains an essential self-awareness component. All animals cannot have it, but human creatures do. Only humans have shown such a capacity from the many animals tested. Animals such as orangutans, chimpanzees, gorillas, bottlenose dolphins, elephants, orcas, bonobos, Rhesus macaques, and European magpies are examples. The Canidae family of animals, including dogs, show subtle displays of self-consciousness."
    },
    {
    ...
    },
    {
      ...
      "a": "Make these diagrams perfect by practising with a few plants and animals that seem relatively easy to draw. Teachers and parents can offer suggestions, or you might even try looking up simple animal or plant figures online."
    },
    {
      "q": "8. Describe One Example of Adaptive Radiation\n.",
      "a": "A lineage or group of individuals evolves into various forms as a result of adaptive radiation. In addition to natural selection, resources and habitats also contribute to the evolution of these forms. The Galapagos Darwin finches may have a common ancestor but now have different beaks based on their food preferences. The different feeding habits and types of beaks these finches possess are due to their different eating habits. It has evolved from a seed-eating finch ancestor to become insectivorous, blood-sucking, and many other types of finches with varied diets."
    },
    {
      "q": "9. Can We Call Human Evolution Adaptive Radiation?",
      "a": "There is no such thing as adaptive radiation in human evolution.\u00a0One way to define adaptive radiation is that it occurs when new species evolve from one common ancestor.\u00a0Even though we share an ancestor, human evolution has seen gradual but progressive changes in our bodies, eating habits, etc. Diversification into new species, a characteristic of adaptive radiation, is not part of human evolution."
    },
    {
      ...
      "a": "During the Eocene period, horses evolved from Eohippus. It involved the following evolutionary stages.\nA trio of Eohippus, Mesohippus, Merychhippus, and Pliohippus led to the emergence of Equus.\nTrends in evolutionary development:\n(i) Increase in body weight.\n(ii) Lengthening of the neck.\n(iii) An increase in leg length.\n(iv) Enlarging the third digit.\n(v) Progressive reduction of lateral digits\n(vi) More complex teeth to feed on grass\n(vii) Strengthening of the back\n(viii) Brain and sensory organ development\nNCERT Solutions for Class 12 Biology Chapter 6 - Evolution\nDownload NCERT Solution of Class 12\u00a0 Biology Chapter 6 Evolution\nStudying Biology can be very fun, or it can be torture. The deciding factor in this situation is the method and platform that the student utilizes to learn Biology. We at Vedantu pride ourselves on providing students with a high-quality education that is both fun and informative.\nStudents can install our app to avail our services. We provide students with Evolution Class 12 NCERT solutions pdf on this page for free to download. Students can also find solutions to other chapters and other subjects on our platform.\nStudents can also enroll in live classes at Vedantu. These live classes are aimed at helping students to understand the basic concept, the course material, and the questions of that chapter.\nThis method of learning helps students in scoring the best possible marks. If students want to further improve their chances of scoring well, then they should download the NCERT Biology Class 12 Chapter Evolution pdf.\nNCERT Solution of Evolution Class 12 - Free PDF Download\nIrrespective of how much a student knows and how hard he or she works, there are bound to be questions that students just don\u2019t know the answer to. If you are in a similar situation, then how would you solve this problem?\nMost students think about waiting for their school classes to start so that they can ask their teachers. Sadly, this is not always possible. This is why we at Vedantu offer a better alternative to students. We provide students with Class 12th Evolution NCERT solutions free pdf that help students to clear their basic concepts of the chapter.\nStudents can download Ch 6 Bio Class 12 NCERT solutions free pdf available on this page. And simply look up answers to questions that they might not be familiar with. Students can also use NCERT solutions for Class 12 Biology Chapter 6 Evolution to learn about the correct format for answering questions in the final examination.\nClass 12 Chapter 6 Biology Evolution\nEvolution 12th NCERT is a chapter that deals with the topic of evolution. The chapter begins on a note that introduces students to the wonders that must have happened for all of us to reach here.\nIn the Evolution Chapter of Class 12th, students learn about various theories of evolution. Darwin\u2019s theory of evolution is also discussed. All in all, this chapter makes for a very interesting read and learning session.\nMarks Weightage of NCERT Biology Class 12 Chapter 6 PDF\nEvolution Chapter Class 12 falls under unit seven. This unit is worth 18 marks and is very important for students to learn. Every single year, many questions are asked from this unit. And those questions tend to range in terms of their marks and the type of questions that are asked from students.\nHence, it is recommended that students should download the Evolution Class 12 pdf from Vedantu. This will allow students to score better marks.\nBenefits of NCERT Solutions of Chapter 6 Biology Class 12\nIf a student has downloaded the NCERT Biology Class 12 Evolution pdf solution, then he or she must have reaped a lot of benefits. Do you wish to know what those benefits are? If yes, then read the list of benefits that are mentioned below.\nStudents can enroll in online live classes to get rid of any doubts that they might have\nThe file can be downloaded for free from the Vedantu platform.\nThe size of the file is small. This means that all students can download this file irrespective of the speed and reliability of their internet connection\nThe answers have been written by the best teachers in India\nAll answers are written according to the guidelines that have been set by CBSE\nYou will be able to enhance the above benefits if you download Class 12 Biology Chapter 6 solutions pdf available on this page. Answers to the Evolution Chapter of Class 12th are available for free!\nHow Would Vedantu Study Material Help in Making Learning Fun?\nWe at Vedantu provide all students with free NCERT solved answers. Students can download these answers by installing the Vedantu app for free. If students download these answers, then they are bound to get better marks in their final examination.\nBut what if a student still has questions about the chapter or subject? In that case, students can either choose to post their questions on the Vedantu platform or enroll in our live classes.\nLive classes are given by the best-rated teachers in India. These teachers have a lot of experience under their belt. They are also highly qualified and feel strongly about helping all students.\nSo, what are you waiting for? Take a step towards education that is better and more fun with Vedantu!\nExplore Study Materials for Class 12 Chapter 6 - Evolution\nS.No.\nImportant Links for Class 12 Chapter 6 Evolution\n1\nChapter 6:\u00a0 Evolution Important Questions\n2\nChapter 6: Evolution Revision Notes\n3\nChapter 6: Evolution NCERT Exemplar Solutions\nNCERT Solutions for Class 12 Biology | Chapter-wise Links\nGiven below are the chapter-wise links for NCERT Solutions for Class 12 Biology. These solutions are provided by the Biology experts at Vedantu in a detailed manner. You can download FREE PDFs of these chapter-wise solutions to be thoroughly familiar with the concepts.\nS.No.\nOther Chapter-wise Links for NCERT Solutions Class 12 Biology\n1\nChapter 1 - Sexual Reproduction in Flowering Plants Solutions\n2\nChapter 2 - Human Reproduction Solutions\n3\nChapter 3 - Reproductive Health Solutions\n4\nChapter 4 - Principles of Inheritance and Variation Solutions\n5\nChapter 5 - Molecular Basis of Inheritance Solutions\n6\nChapter 7 - Human Health and Disease Solutions\n7\nChapter 8 - Microbes in Human Welfare Solutions\n8\nChapter 9 - Biotechnology Principles and Processes Solutions\n9\nChapter 10 - Biotechnology and Its Applications Solutions\n10\nChapter 11 - Organisms and Populations Solutions\n11\nChapter 12 - Ecosystem Solutions\n12\nChapter 13 - Biodiversity and Conservation Solutions\nOther Related Links for Class 12 Biology\nS.No.\nImportant Links for Class 12 Biology"
    },
    {
      "q": "1.\nCBSE Class 12 Biology Important Questions",
      "a": "Detailed solution available."
    ...
    {
      "q": "7.\nCBSE Class 12 Biology Syllabus\nConclusion\nNCERT Solutions for Class 12 Biology Chapter 6 - Evolution offer a crucial resource for students delving into the captivating world of biological evolution. This chapter explores the fundamental principles of evolution, natural selection, speciation, and the evidence supporting the theory. These solutions, available in various formats, provide clear explanations, diagrams, and comprehensive answers to textbook questions, aiding students in mastering complex evolutionary concepts. Understanding evolution is not only essential for academic success but also for comprehending the diversity of life on Earth and its ecological significance. These NCERT solutions play a pivotal role in facilitating a deeper understanding of evolution, making them an indispensable asset for students on their biology journey.",
      "a": "Detailed solution available."
    }
  ],
  "7": [
    {
      "q": "1. What are the various public health measures you would suggest as a safeguard against infectious diseases?",
      "a": "Public health measures are preventive measures that are taken to check the spread of various infectious diseases. These measures should be taken to reduce contact with infectious agents.\u00a0 Some of these methods are:\n(1) Personal and Public Hygiene Should be Maintained\n: One of the most important methods of preventing infectious diseases is the maintenance of personal and public hygiene. Personal hygiene involves maintaining a clean body,\u00a0 consumption of healthy and nutritious food, drinking clean water, etc. Whereas public hygiene involves proper disposal of waste material, excreta, periodic cleaning, and disinfection of water reservoirs.\n(2) Isolation of Infected Persons:\nTo prevent the spread of air-borne diseases such as pneumonia,\u00a0 chickenpox, tuberculosis, etc., it is essential to keep the infected person in isolation to reduce the chances of spreading these diseases.\n(3) Vaccination:\nThe protection of the body from communicable diseases by administering some agent that mimics the microbe inside the body is known as vaccination. It provides both active and passive immunization to the body.\u00a0 Various vaccines are available for the treatment of many diseases such as tetanus, polio, measles, mumps, etc.\n(4) Vector Eradication:\nMany diseases such as malaria, filariasis, dengue, and chikungunya spread through vectors. By providing a clean environment and preventing the breeding of mosquitoes these diseases can be prevented easily. By not allowing water to stagnate around residential areas, the breeding of mosquitoes can be prevented. To keep our environment healthy, regular cleaning of coolers should be done, also the use of mosquito nets, and insecticides such as malathion in drains, ponds, etc. should be considered. Fish such as Gambusia are introduced in ponds to control the breeding of mosquito larvae in stagnant water."
    },
    {
      "q": "2. In which way has the study of biology helped us to control infectious diseases?",
      "a": "In the field of biology, various advancements once a person starts taking alcohol or drugs have helped us in gaining a better understanding to fight against various infectious diseases. Biology has helped us in studying the life cycle of various parasites, pathogens, and vectors along with their modes of transmission and controlling measures. Vaccination programs against several infectious diseases such as smallpox, chickenpox, tuberculosis, etc. have helped nearly eradicate these diseases. In the preparation of newer or safer drugs and vaccines, biotechnology has helped a lot. In treating infectious diseases the antibiotics have also played a very important role."
    },
    {
    ...
    {
      "q": "4.\nBiology Class 12 Previous Year Question Paper",
      "a": "Detailed solution available."
    },
    {
      "q": "5.\nBiology Class 12 Sample Paper",
  ...
  "8": [
    ...
    },
    {
      ...
      "a": "The amount of oxygen required by micro-organisms to decompose the waste present in the water supply is determined using the Biological Oxygen Demand (BOD) method. When the water supply contains high levels of organic wastes, the number of decomposing bacteria also increases, leading to a higher BOD value. Consequently, water supplies that are more polluted tend to have higher BOD values. Sample C, with a BOD value of 400 mg/L, is the most polluted among the three samples. The discharge of secondary effluent from a sewage treatment plant is more polluted than river water, which explains why sample A has a higher BOD value of 20 mg/L compared to sample B, which has a BOD value of 8 mg/L and is sourced from a river.\nHence, the correct label for each samples are:\nLabel\nBOD Value\nSample\nSample A\n20 mg/L\nSecondary effluent discharge from a sewage treatment plant\nSample B\n8 mg/L\nRiver water\nSample C\n400 mg/L\nUntreated sewage water"
    },
    {
  ...
  "10": [
    {
      "q": "1. ADA is an enzyme which is crucial for the immune system to function. What is the full form of ADA?",
      "a": "Adenosine deaminase is an enzyme which is crucial for the immune system to function"
    },
    {
      "q": "2. Name a molecular diagnostic technique to detect the presence of a pathogen in its early stage of infection.",
      "a": "Enzyme Linked Immunosorbent Assay (ELISA) detects the presence of a pathogen in its early stage of infection."
    },
    {
      "q": "3. What does Bt in Bt cotton stands for?",
      "a": "Bt in Bt cotton stands for\nBacillus thuringiensis."
    },
    {
      "q": "4. What was the name of first transgenic cow?",
      "a": "First transgenic cow was named Rosie."
    },
    {
      "q": "5. What does GEAC stands for?",
      "a": "GEAC stands for Genetic Engineering Approval Committee.\nSection\u2212B (2 Mark Questions)"
    },
    {
      "q": "6. What is Biopiracy?",
      "a": "Biopiracy refers to the use of bio-resources by multinational companies and other organisations without proper authorisation from the countries and people concerned without compensatory payment."
    },
    {
      "q": "7. Answer the following questions.\n(i)\nFor which Indian rice variety was patent filed by a USA company?\n(ii)\nHow are \u2018cry\u2019 and \u2018CRY\u2019 different from each other?",
      "a": "(i)\nBasmati rice is an Indian rice variety for which the patent was files by a USA company.\n(ii)\n\u2018cry\u2019 is the gene that encodes for \u2018CRY\u2019 protein (Bt toxin)."
    },
    {
      "q": "8. What are the main objectives of GEAC?",
      "a": "GEAC is Genetic Engineering Approval Committee. It is an Indian government organization. Its main objectives are as follows:\nTo examine the validity of genetic modification research.\nTo inspect whether the use of genetically modified crops is safe for public use or not."
    },
    {
      "q": "9. Name the following questions.\n(i)\nName the source organism of the gene\ncryIAc\nand its target pest.\n(ii)\nName the cry genes that control cotton bollworm and com borer respectively.",
      "a": "(i)\nSource of gene\ncrylAc\nis\nBacillus thuringiensis\nand its target pest-cotton bollworms.\n(ii)\nThe cry genes that control Cotton boll\nworm are\ncryIAc\nand\ncryIIAb\n, and Corn borer is controlled by the gene\ncryIAb."
    },
    {
      "q": "10. Why should not the patent on Basmati have gone to an American company?",
      "a": "The patent on Basmati shouldn\u2019t have gone to an American company for the following reasons:\nThe Basmati rice variety traditionally belongs to India.\nThe patented variety of Basmati was derived from \u2018Indian farmer\u2019s variety\u2019."
    },
    {
      "q": "11. Answer the following questions.\n(i)\nWhat are genetically modified organisms (GMO)?\n(ii)\nGive an example of GMO.",
      "a": "(i)\nGenetically modified organisms (GMOs) are those organisms (i.e., plants, animals or microorganisms) in which the genetic material (DNA) has been altered in a way that does not occur naturally by mating and/or natural recombination.\n(ii)\nGolden rice is an example of GM crop.\nPDF Summary - Class 12 Biology Bio-technology and Its Application Notes (Chapter 1)"
    },
    {
  ...
  "11": [
    ...
    {
      "q": "7.\nCBSE Class 12 Biology Syllabus\nConclusion\nVedantu's Organism and Population Class 12 NCERT Solutions for CBSE Biology Chapter 11 provide a comprehensive and reliable resource for students studying this topic. The solutions are designed to help students understand the concepts of organisms and populations in a clear and concise manner. With detailed explanations, examples, and diagrams, the solutions enable students to grasp the fundamental principles of this chapter effectively. Additionally, the solutions are aligned with the NCERT syllabus, ensuring that students receive accurate information and guidance. Overall, Vedantu's Organism and Population Class 12 NCERT Solutions offer a valuable tool for students to enhance their understanding and excel in their biology studies.",
      "a": "Detailed solution available."
    }
  ],
  "12": [
    ...
    },
    {
      ...
      "a": "The difference between the grazing food chain and the detritus food chain are:\nGrazing food chain\nDetritus food chain"
    },
    {
