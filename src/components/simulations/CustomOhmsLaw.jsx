    ...
    pointerEvents: 'none'
      ...
      pointerEvents: 'auto'
        ...
        gap: '6px'
          ...
          }}>{voltage.toFixed(1)} V</span>
          </div>
          <input type="range" min="0.1" max="9.0" step="0.1" value={voltage} onChange={e => setVoltage(parseFloat(e.target.value))} style={{
          accentColor: '#3498db',
          cursor: 'pointer',
          width: '100%'
        }} />
        ...
        gap: '6px'
          ...
          <input type="range" min="10" max="1000" step="10" value={resistance} onChange={e => setResistance(parseInt(e.target.value))} style={{
          accentColor: '#2ecc71',
          cursor: 'pointer',
          width: '100%'
        }} />
