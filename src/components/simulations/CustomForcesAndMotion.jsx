    ...
    overflow: 'hidden'
        ...
        border: '1px solid rgba(52, 152, 219, 0.2)'
          ...
          lineHeight: 1.5
            ...
            color: '#3498db'
                        ...
                        Where <span style={{
            fontFamily: 'monospace'
          }}>F_net = F_applied - F_friction</span>.
                    </p>
                </div>
            </div>
        ...
        gap: '24px'
            ...
            marginBottom: '8px'
              ...
              fontWeight: 700
                        ...
                        <input type="range" min="-500" max="500" step="10" value={appliedForce} onChange={e => setAppliedForce(Number(e.target.value))} style={{
            width: '100%',
            accentColor: '#3498db'
          }} />
                        <div style={{
            ...
            marginBottom: '8px'
              ...
              color: '#3498db',
              fontWeight: 700
            }}>{frictionMu > 0 ? 'Active' : 'None'}</span>
                        </div>
                        <input type="range" min="0" max="0.5" step="0.1" value={frictionMu} onChange={e => setFrictionMu(Number(e.target.value))} style={{
            width: '100%',
            accentColor: '#3498db'
          }} />
                        <div style={{
            ...
            marginBottom: '8px'
              ...
              fontWeight: 700
                        ...
                        <input type="range" min="10" max="200" step="10" value={mass} onChange={e => setMass(Number(e.target.value))} style={{
            width: '100%',
            accentColor: '#3498db'
          }} />
                        <div style={{
      ...
      zIndex: 1
        ...
        pointerEvents: 'none'
                ...
                <svg viewBox="-500 -300 1000 600" preserveAspectRatio="xMidYMid meet" style={{
        position: 'absolute',
        top: 0,
        left: 0,
        right: 0,
        ...
        pointerEvents: 'none'
                    ...
                    <g transform="translate(0, 100)">
                        ...
                        <g transform="translate(-50, -70)" style={{
            cursor: 'pointer',
            pointerEvents: 'auto'
