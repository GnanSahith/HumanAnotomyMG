  ...
  useEffect(() => {
    ...
    if (!isPlayingRef.current) {
      ...
      for (let i = 0; i < history.length; i++) {
        ...
        if (i === 0) graphCtx.moveTo(hx, hy);else graphCtx.lineTo(hx, hy);
      }
      graphCtx.stroke();
    ...
    flexDirection: 'column'
      ...
      gap: '20px'
        ...
        boxShadow: '0 8px 32px rgba(0,0,0,0.4)'
          ...
          <canvas ref={canvasRef} width={800} height={400} onMouseDown={handleMouseDown} onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onMouseLeave={handleMouseLeave} style={{
          width: '100%',
          height: '100%',
          objectFit: 'contain',
          display: 'block',
        ...
        boxSizing: 'border-box'
          ...
          display: 'block',
          marginBottom: '8px'
        }}>EMF vs Time (Oscilloscope)</span>
          <canvas ref={graphCanvasRef} width={800} height={100} style={{
          display: 'block',
          width: '100%',
      ...
      boxSizing: 'border-box'
        ...
        gap: '12px'
          ...
          marginTop: '10px'
            ...
            <input type="range" min="1" max="10" step="1" value={turns} onChange={e => setTurns(Number(e.target.value))} style={{
            width: '100%',
            accentColor: '#3498db'
          }} />
          </div>
          ...
          marginTop: '10px'
            ...
            <input type="range" min="20" max="100" step="1" value={area} onChange={e => setArea(Number(e.target.value))} style={{
            width: '100%',
            accentColor: '#2ecc71'
          }} />
          </div>
          ...
          marginTop: '10px'
            ...
            <input type="range" min="10" max="300" step="10" value={strength} onChange={e => setStrength(Number(e.target.value))} style={{
            width: '100%',
            accentColor: '#e74c3c'
          }} />
          </div>
