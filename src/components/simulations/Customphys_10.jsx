...
const Customphys_10Inner = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i <= binCount; i++) {
      bins.push(Bodies.rectangle(binStartX + i * binWidth - binWidth / 2, binStartY, 4, binHeight, {
        isStatic: true,
        render: {
          fillStyle: '#888888'
        }
  ...
  return <div className="simulation-container" style={{
    display: 'flex',
...
export default function Customphys_10({
  onBack,
  ...
  return <div style={{
    ...
    background: '#0a0a1a'
      ...
      pointerEvents: 'auto'
                 ...
                 <Customphys_10Inner onBack={onBack} title={title} />
            </div>
        </div>;
}