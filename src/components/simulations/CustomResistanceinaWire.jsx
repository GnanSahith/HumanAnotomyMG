    ...
    <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', pointerEvents: 'none' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ transform: `scale(${rSize})`, transition: 'transform 0.2s', transformOrigin: 'center', fontSize: '48px', fontWeight: 'bold', color: '#fff', position: 'absolute', left: '60px' }}>
            R
          </div>
          <div style={{ fontSize: '40px', fontWeight: 'bold', color: 'rgba(255,255,255,0.7)', position: 'absolute', left: '140px' }}>=</div>
          
          <div style={{ display: 'flex', alignItems: 'center', position: 'absolute', left: '200px' }}>
            <div style={{ transform: `scale(${rhoSize})`, transition: 'transform 0.2s', transformOrigin: 'center', fontSize: '48px', fontWeight: 'bold', color: '#ff4444', marginRight: '20px' }}>
              ρ
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <div style={{ transform: `scale(${lSize})`, transition: 'transform 0.2s', transformOrigin: 'bottom', fontSize: '40px', fontWeight: 'bold', color: '#3b82f6', lineHeight: '1' }}>
                L
              </div>
              <div style={{ width: '60px', height: '3px', background: 'rgba(255, 255, 255, 0.4)', margin: '6px 0' }}></div>
              <div style={{ transform: `scale(${aSize})`, transition: 'transform 0.2s', transformOrigin: 'top', fontSize: '40px', fontWeight: 'bold', color: '#2ecc71', lineHeight: '1' }}>
                A
              </div>
            </div>
          </div>
        ...
        <div style={{
          ...
          <canvas ref={canvasRef} width={400} height={200} style={{ display: 'block', borderRadius: '12px' }} />
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px' }}>
            <span style={{ color: '#ff4444', fontWeight: '600' }}>Resistivity (ρ):</span>
            <span style={{ fontWeight: '600', fontFamily: 'monospace' }}>{resistivity.toFixed(2)} Ω·cm</span>
          </div>
          <input
            type="range"
            min="0.1"
            ...
            style={{ accentColor: '#ff4444', cursor: 'pointer', width: '100%' }}
          />
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px' }}>
            <span style={{ color: '#3b82f6', fontWeight: '600' }}>Length (L):</span>
            <span style={{ fontWeight: '600', fontFamily: 'monospace' }}>{length.toFixed(1)} cm</span>
          </div>
          <input
            type="range"
            min="0.1"
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px' }}>
            <span style={{ color: '#2ecc71', fontWeight: '600' }}>Area (A):</span>
            <span style={{ fontWeight: '600', fontFamily: 'monospace' }}>{area.toFixed(1)} cm²</span>
          </div>
          <input
            type="range"
            min="0.1"
        ...
        <div style={{
          ...
          <span style={{ fontSize: '22px', fontWeight: 'bold', color: '#fff', fontFamily: 'monospace' }}>
...
export default function CustomResistanceInAWire({ onBack, title }) {
    return (
