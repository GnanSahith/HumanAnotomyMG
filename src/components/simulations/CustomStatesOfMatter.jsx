...
export default function CustomStatesOfMatter({
  onBack,
        ...
        paddingBottom: '10px'
          ...
          fontSize: '14px'
            ...
            color: 'rgba(255,255,255,0.6)'
                        ...
                        <span style={{
            fontWeight: 600,
            color: substances[substance].color
          }}>{substance}</span>
                    </div>
                    <div style={{
          display: 'flex',
          ...
          fontSize: '14px'
            ...
            color: 'rgba(255,255,255,0.6)'
                        ...
                        <span style={{
            fontWeight: 600
          }}>{substances[substance].mass} u</span>
                    </div>
                    <div style={{
          display: 'flex',
          justifyContent: 'space-between',
          ...
          fontSize: '14px'
                        ...
                        <span style={{
            color: 'rgba(255,255,255,0.6)'
          }}>Particle Radius:</span>
                        <span style={{
            fontWeight: 600
          }}>{substances[substance].radius} pm</span>
                    </div>
                    <div style={{
          display: 'flex',
          justifyContent: 'space-between',
          ...
          fontSize: '14px'
            ...
            color: 'rgba(255,255,255,0.6)'
                        ...
                        <span style={{
            fontWeight: 600
          }}>{substances[substance].epsilon} eV</span>
                    </div>
                    <div style={{
          display: 'flex',
          justifyContent: 'space-between',
          fontSize: '14px'
                        ...
                        <span style={{
            color: 'rgba(255,255,255,0.6)'
          }}>Size Parameter (σ):</span>
                        <span style={{
            fontWeight: 600
          }}>{substances[substance].sigma} pm</span>
                    </div>
                </div>
