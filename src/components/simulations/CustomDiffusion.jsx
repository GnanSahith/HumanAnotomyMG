...
export default function CustomDiffusion({
  ...
  const updatePhysics = () => {
    ...
    for (let i = 0; i < p.length; i++) {
      ...
      for (let j = i + 1; j < p.length; j++) {
        ...
        if (Math.abs(p1.x - p2.x) < c1.radius + c2.radius && Math.abs(p1.y - p2.y) < c1.radius + c2.radius) {
  ...
  const handleConfigChange = (type, key, value) => {
    if (type === 'A') setConfigA(prev => ({
      ...prev,
      [key]: value
    }));else setConfigB(prev => ({
      ...prev,
      [key]: value
    }));
  };
    ...
    fontFamily: 'system-ui, -apple-system, sans-serif'
      ...
      paddingRight: '400px' // Make room for the right sidebar
        ...
        zIndex: 2
          ...
          }}>Left: {counts.aLeft}</div>
                        <div style={{
            color: 'rgba(255,255,255,0.8)'
          }}>Right: {counts.aRight}</div>
                    </div>
                    <div>
                        <div style={{
            fontWeight: 'bold',
            ...
            marginBottom: '6px'
                        ...
                        <div style={{
            color: 'rgba(255,255,255,0.8)'
          }}>Left: {counts.bLeft}</div>
                        <div style={{
            color: 'rgba(255,255,255,0.8)'
          }}>Right: {counts.bRight}</div>
                    </div>
                </div>}
            
            {showStopwatch && <div style={{
        position: 'absolute',
        top: '16px',
        left: '240px',
        background: 'rgba(20, 20, 30, 0.85)',
        ...
        color: '#fff'
          ...
          gap: '16px'
                    ...
                    <button onClick={() => setDividerRemoved(!dividerRemoved)} style={{
            width: '100%',
            padding: '12px',
            borderRadius: '10px',
            fontWeight: 600,
            ...
            color: 'rgba(255,255,255,0.8)'
              ...
              cursor: 'pointer'
                            ...
                            <input type="checkbox" checked={showData} onChange={e => setShowData(e.target.checked)} style={{
                accentColor: '#3498db',
                width: '16px',
                height: '16px',
                cursor: 'pointer'
              ...
              cursor: 'pointer'
                            ...
                            <input type="checkbox" checked={showStopwatch} onChange={e => setShowStopwatch(e.target.checked)} style={{
                accentColor: '#3498db',
                width: '16px',
                height: '16px',
                cursor: 'pointer'
          ...
          gap: '16px'
              ...
              color: 'rgba(255,255,255,0.6)'
                ...
                fontWeight: 'bold'
                        ...
                        <input type="range" min="0" max="200" value={configA.count} onChange={e => handleConfigChange('A', 'count', parseInt(e.target.value))} style={{
              width: '100%',
              accentColor: '#e74c3c',
              cursor: 'pointer'
            }} />
              ...
              color: 'rgba(255,255,255,0.6)'
                ...
                fontWeight: 'bold'
                        ...
                        <input type="range" min="1" max="100" value={configA.mass} onChange={e => handleConfigChange('A', 'mass', parseInt(e.target.value))} style={{
              width: '100%',
              accentColor: '#e74c3c',
              cursor: 'pointer'
            }} />
              ...
              color: 'rgba(255,255,255,0.6)'
                ...
                fontWeight: 'bold'
                        ...
                        <input type="range" min="5" max="30" value={configA.radius} onChange={e => handleConfigChange('A', 'radius', parseInt(e.target.value))} style={{
              width: '100%',
              accentColor: '#e74c3c',
              cursor: 'pointer'
            }} />
              ...
              color: 'rgba(255,255,255,0.6)'
                ...
                fontWeight: 'bold'
                        ...
                        <input type="range" min="50" max="600" value={configA.temp} onChange={e => handleConfigChange('A', 'temp', parseInt(e.target.value))} style={{
              width: '100%',
              accentColor: '#e74c3c',
              cursor: 'pointer'
            }} />
          ...
          gap: '16px'
              ...
              color: 'rgba(255,255,255,0.6)'
                ...
                fontWeight: 'bold'
                        ...
                        <input type="range" min="0" max="200" value={configB.count} onChange={e => handleConfigChange('B', 'count', parseInt(e.target.value))} style={{
              width: '100%',
              accentColor: '#3498db',
              cursor: 'pointer'
            }} />
              ...
              color: 'rgba(255,255,255,0.6)'
                ...
                fontWeight: 'bold'
                        ...
                        <input type="range" min="1" max="100" value={configB.mass} onChange={e => handleConfigChange('B', 'mass', parseInt(e.target.value))} style={{
              width: '100%',
              accentColor: '#3498db',
              cursor: 'pointer'
            }} />
              ...
              color: 'rgba(255,255,255,0.6)'
                ...
                fontWeight: 'bold'
                        ...
                        <input type="range" min="5" max="30" value={configB.radius} onChange={e => handleConfigChange('B', 'radius', parseInt(e.target.value))} style={{
              width: '100%',
              accentColor: '#3498db',
              cursor: 'pointer'
            }} />
              ...
              color: 'rgba(255,255,255,0.6)'
                ...
                fontWeight: 'bold'
                        ...
                        <input type="range" min="50" max="600" value={configB.temp} onChange={e => handleConfigChange('B', 'temp', parseInt(e.target.value))} style={{
              width: '100%',
              accentColor: '#3498db',
              cursor: 'pointer'
            }} />
