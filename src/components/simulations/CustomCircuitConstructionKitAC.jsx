...
import { ArrowLeft, RotateCcw, Play, Pause, Settings2 } from 'lucide-react';
  ...
  return <div style={{
    ...
    overflow: 'hidden'
      ...
      justifyContent: 'center'
                ...
                <canvas ref={canvasRef} width={800} height={500} style={{
        width: '100%',
        height: '100%',
        maxHeight: '100%',
        objectFit: 'contain',
        ...
        gap: '15px'
          ...
          paddingBottom: '10px'
                ...
                <button onClick={() => setRunning(!running)} className="ds-btn-glass" style={{
          width: '100%',
          justifyContent: 'center'
        }}>
          ...
          gap: '12px'
                    ...
                    {components.map((c, i) => <div key={c.id} style={{
            padding: '12px',
            background: 'rgba(255, 255, 255, 0.05)',
            border: '1px solid rgba(255, 255, 255, 0.1)',
            borderRadius: '10px',
              ...
              color: '#e2e8f0'
                  ...
                  marginBottom: '4px'
                    ...
                    fontWeight: 'bold'
                                        ...
                                        <input type="range" min="0" max="20" step="0.5" value={c.amplitude} onChange={e => updateComponent(i, 'amplitude', e.target.value)} style={{
                  width: '100%',
                  accentColor: '#3498db',
                  cursor: 'pointer'
                }} />
                  ...
                  marginBottom: '4px'
                    ...
                    fontWeight: 'bold'
                                        ...
                                        <input type="range" min="0.1" max="5" step="0.1" value={c.freq} onChange={e => updateComponent(i, 'freq', e.target.value)} style={{
                  width: '100%',
                  accentColor: '#3498db',
                  cursor: 'pointer'
                }} />
                ...
                marginBottom: '4px'
                  ...
                  fontWeight: 'bold'
                                    ...
                                    <input type="range" min="1" max="50" step="1" value={c.value} onChange={e => updateComponent(i, 'value', e.target.value)} style={{
                width: '100%',
                accentColor: '#3498db',
                cursor: 'pointer'
              }} />
                ...
                marginBottom: '4px'
                  ...
                  fontWeight: 'bold'
                                    ...
                                    <input type="range" min="0.1" max="5" step="0.1" value={c.value} onChange={e => updateComponent(i, 'value', e.target.value)} style={{
                width: '100%',
                accentColor: '#3498db',
                cursor: 'pointer'
              }} />
                ...
                marginBottom: '4px'
                  ...
                  fontWeight: 'bold'
                                    ...
                                    <input type="range" min="0.01" max="0.5" step="0.01" value={c.value} onChange={e => updateComponent(i, 'value', e.target.value)} style={{
                width: '100%',
                accentColor: '#3498db',
                cursor: 'pointer'
              }} />
