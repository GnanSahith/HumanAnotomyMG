...
import { ArrowLeft, RotateCcw, Play, Pause, FastForward, GripHorizontal, Settings2 } from 'lucide-react';
const CustomEnergySkatePark = ({
  onBack,
  title
}) => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      for (let x = s.p1.x; x <= s.p3.x; x += 5) {
        const y = A * x * x + B * x + C;
        if (x === s.p1.x) ctx.moveTo(x, y);else ctx.lineTo(x, y);
      }
      ctx.stroke();
  ...
  const handlePointerDown = e => {
    ...
    if (dist({
      ...
      x,
      y
    }, s.p1) < 20) s.dragTarget = 'p1';else if (dist({
      x,
      y
    }, s.p2) < 20) s.dragTarget = 'p2';else if (dist({
      x,
      y
    }, s.p3) < 20) s.dragTarget = 'p3';
    if (s.dragTarget) {
      ...
      gap: '20px'
        ...
        flexDirection: 'column'
          ...
          gap: '10px'
            ...
            label: 'Total',
            color: '#f1c40f'
          }].map((item, i) => <div key={item.label} style={{
            display: 'flex',
            flexDirection: 'column',
            alignItems: 'center',
            width: '40px',
        ...
        gap: '20px'
          ...
          borderRadius: '12px'
            ...
            fontSize: '14px'
                            ...
                            <input type="checkbox" checked={showBarGraph} onChange={e => setShowBarGraph(e.target.checked)} style={{
              accentColor: '#3498db'
            }} />
                            Bar Graph
                        </label>
          ...
          borderRadius: '12px'
              ...
              fontSize: '14px'
                ...
                color: 'rgba(255, 255, 255, 0.8)'
                                ...
                                <span style={{
                fontWeight: '500'
              }}>{friction === 0 ? 'None' : friction.toFixed(2)}</span>
                            </div>
                            <input type="range" min="0" max="0.5" step="0.01" value={friction} onChange={e => setFriction(parseFloat(e.target.value))} style={{
              width: '100%',
              accentColor: '#3498db'
            }} />
                        </div>
              ...
              fontSize: '14px'
                ...
                fontWeight: '500'
                            ...
                            <input type="range" min="1" max="20" step="0.1" value={gravity} onChange={e => setGravity(parseFloat(e.target.value))} style={{
              width: '100%',
              accentColor: '#2ecc71'
            }} />
                        </div>
              ...
              fontSize: '14px'
                ...
                fontWeight: '500'
                            ...
                            <input type="range" min="5" max="100" step="1" value={mass} onChange={e => setMass(parseFloat(e.target.value))} style={{
              width: '100%',
              accentColor: '#bf5af2'
            }} />
                        </div>
