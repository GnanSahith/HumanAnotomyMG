    ...
    <div style={{ width: '70%', height: '100%', position: 'relative' }}>
      ...
      <svg viewBox="-400 -1050 2800 1300" preserveAspectRatio="xMidYMid meet" style={{ width: '100%', height: '100%', display: 'block' }}>
        ...
        <g clipPath="url(#simBoxClip)">
          <image href="/assets/physics_landscape_bg.jpg" x="-400" y="-1050" width="2800" height="1300" preserveAspectRatio="xMidYMid slice" opacity="0.35" />
          {/* Moderate dark overlay to ensure simulation elements pop but background is still visible (~25%) */}
          <rect x="-400" y="-1050" width="2800" height="1300" fill="rgba(15, 15, 26, 0.75)" />
        </g>
