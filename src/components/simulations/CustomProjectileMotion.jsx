  ...
  return <div style={{
    ...
    color: '#fff'
      ...
      gap: '20px'
        ...
        paddingBottom: '10px'
          ...
          marginBottom: '8px'
            ...
            fontWeight: 700
                    ...
                    <input type="range" min="0" max="40" value={velocity} onChange={e => setVelocity(Number(e.target.value))} style={{
          width: '100%',
          accentColor: '#ff9f0a',
          cursor: 'pointer'
        }} />
          ...
          marginBottom: '8px'
            ...
            fontWeight: 700
                    ...
                    <input type="range" min="0" max="90" value={angle} onChange={e => setAngle(Number(e.target.value))} style={{
          width: '100%',
          accentColor: '#ff9f0a',
          cursor: 'pointer'
        }} />
          ...
          marginBottom: '8px'
            ...
            fontWeight: 700
                    ...
                    <input type="range" min="0" max="15" step="1" value={height} onChange={e => setHeight(Number(e.target.value))} style={{
          width: '100%',
          accentColor: '#ff9f0a',
          cursor: 'pointer'
        }} />
        ...
        margin: 0
          ...
          marginBottom: '8px'
            ...
            fontWeight: 700
                    ...
                    <input type="range" min="0.1" max="10" step="0.1" value={mass} onChange={e => setMass(Number(e.target.value))} style={{
          width: '100%',
          accentColor: '#3498db',
          cursor: 'pointer'
        }} />
          ...
          marginBottom: '8px'
            ...
            color: '#3498db',
            fontWeight: 700
          }}>{diameter.toFixed(2)} m</span>
                    </div>
                    <input type="range" min="0.1" max="1.0" step="0.05" value={diameter} onChange={e => setDiameter(Number(e.target.value))} style={{
          width: '100%',
          accentColor: '#3498db',
          cursor: 'pointer'
        }} />
        ...
        gap: '16px'
          ...
          padding: '4px 0'
                        ...
                        <input type="checkbox" checked={airResistance} onChange={e => setAirResistance(e.target.checked)} style={{
            cursor: 'pointer',
            width: '16px',
            height: '16px',
            accentColor: '#3498db'
            ...
            marginBottom: '8px'
              ...
              color: '#2ecc71',
              fontWeight: 700
            }}>{dragCoefficient.toFixed(2)}</span>
                            </div>
                            <input type="range" min="0.1" max="1.5" step="0.01" value={dragCoefficient} onChange={e => setDragCoefficient(Number(e.target.value))} style={{
            width: '100%',
            accentColor: '#2ecc71',
            cursor: 'pointer'
          }} />
      ...
      zIndex: 1
                ...
                <svg viewBox="-400 -1050 2800 1300" preserveAspectRatio="xMidYMid meet" style={{
        width: '100%',
        height: '100%',
        display: 'block'
      }}>
          ...
          return <g key={i}>
                    ...
                    {/* Projectile */}
                    <circle cx={projectilePos.x} cy={-projectilePos.y} r={Math.max(20, diameter * 50)} // Scale visual radius slightly by diameter
        fill="url(#projectileGradient)" filter="drop-shadow(0 0 10px rgba(255,159,10,0.6))" />
