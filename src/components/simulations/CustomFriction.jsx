    ...
    overflow: 'hidden'
      ...
      boxSizing: 'border-box'
        ...
        gap: '4px'
                    ...
                    <div ref={bookRef} onPointerDown={handlePointerDown} onPointerMove={handlePointerMove} onPointerUp={handlePointerUp} onPointerCancel={handlePointerUp} style={{
          width: '260px',
          height: '60px',
      ...
      boxSizing: 'border-box'
                ...
                <Thermometer size={40} color={'#ff375f'} style={{
        filter: 'drop-shadow(0 0 8px rgba(255, 55, 95, 0.5))'
      }} />
                <div style={{
        width: '24px',
        flex: 1,
