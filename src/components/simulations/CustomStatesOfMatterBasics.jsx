...
export default function CustomStatesOfMatterBasics({
  ...
  const renderCanvas = () => {
    ...
    for (let i = 0; i < p.length; i++) {
      ...
      let grad = ctx.createRadialGradient(p[i].x - subParams.radius * 0.3, p[i].y - subParams.radius * 0.3, subParams.radius * 0.1, p[i].x, p[i].y, subParams.radius);
    ...
    background: '#0a0a1a'
      ...
      pointerEvents: 'none'
        ...
        pointerEvents: 'auto'
          ...
          boxShadow: 'inset 0 2px 10px rgba(0,0,0,0.5)'
            ...
            background: temperature > 300 ? 'linear-gradient(180deg, #ff453a, #ff3b30)' : temperature > 100 ? 'linear-gradient(180deg, #ff9f0a, #ff9500)' : 'linear-gradient(180deg, #64d2ff, #0a84ff)',
      ...
      overflowY: 'auto'
        ...
        gap: '8px'
          ...
          justifyContent: 'center',
          gap: '8px',
          background: isPlaying ? 'rgba(231, 76, 60, 0.15)' : 'rgba(46, 204, 113, 0.15)',
          border: `1px solid ${isPlaying ? 'rgba(231, 76, 60, 0.3)' : 'rgba(46, 204, 113, 0.3)'}`,
          ...
          e.currentTarget.style.background = isPlaying ? 'rgba(231, 76, 60, 0.25)' : 'rgba(46, 204, 113, 0.25)';
          e.currentTarget.style.borderColor = isPlaying ? '#e74c3c' : '#2ecc71';
        }} onMouseLeave={e => {
          e.currentTarget.style.background = isPlaying ? 'rgba(231, 76, 60, 0.15)' : 'rgba(46, 204, 113, 0.15)';
          e.currentTarget.style.borderColor = isPlaying ? 'rgba(231, 76, 60, 0.3)' : 'rgba(46, 204, 113, 0.3)';
        }}>
        ...
        margin: 0
          ...
          gap: '8px'
                        ...
                        {Object.keys(substances).map(sub => <button key={sub} onClick={() => setSubstance(sub)} style={getButtonSubstanceStyle(sub)} onMouseEnter={e => {
            if (substance !== sub) {
            ...
            if (substance !== sub) {
              ...
              height: '12px',
              borderRadius: '50%',
              background: substances[sub].color
            }} />
                                {sub}
                            </button>)}
                    </div>
        ...
        margin: 0
          ...
          gap: '8px'
                        ...
                        {['Solid', 'Liquid', 'Gas'].map(p => <button key={p} onClick={() => setPhase(p)} style={getPhaseButtonStyle(p)} onMouseEnter={e => {
            if (phase !== p) {
              e.currentTarget.style.background = 'rgba(255, 255, 255, 0.08)';
              e.currentTarget.style.borderColor = 'rgba(255, 255, 255, 0.2)';
            }
          ...
          gap: '8px'
            ...
            color: 'rgba(255,255,255,0.6)'
              ...
              fontWeight: 600
                        ...
                        <input type="range" min={MIN_TEMP} max={MAX_TEMP} value={temperature} onChange={e => {
