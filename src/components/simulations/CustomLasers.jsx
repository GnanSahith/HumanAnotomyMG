    ...
    fontFamily: "'Inter', sans-serif"
      ...
      boxShadow: '0 20px 40px rgba(0,0,0,0.5)'
        ...
        gap: '6px'
          ...
          <input type="range" min="0" max="100" step="1" value={pumpIntensity} onChange={e => setPumpIntensity(Number(e.target.value))} style={{
          width: '100%',
          accentColor: '#3498db',
          cursor: 'pointer'
        }} />
        ...
        gap: '6px'
          ...
          fontSize: '13px'
            ...
            <span style={{
            color: 'rgba(255,255,255,0.8)'
          }}>Left Mirror Reflectivity</span>
            <span style={{
            color: '#3498db',
            fontWeight: 'bold'
          }}>{leftMirror}%</span>
          </div>
          <input type="range" min="0" max="100" step="1" value={leftMirror} onChange={e => setLeftMirror(Number(e.target.value))} style={{
          width: '100%',
          accentColor: '#3498db',
          cursor: 'pointer'
        }} />
        ...
        gap: '6px'
          ...
          fontSize: '13px'
            ...
            <span style={{
            color: 'rgba(255,255,255,0.8)'
          }}>Right Mirror Reflectivity</span>
            <span style={{
            color: '#3498db',
            fontWeight: 'bold'
          }}>{rightMirror}%</span>
          </div>
          <input type="range" min="0" max="100" step="1" value={rightMirror} onChange={e => setRightMirror(Number(e.target.value))} style={{
          width: '100%',
          accentColor: '#3498db',
          cursor: 'pointer'
        }} />
        ...
        color: 'rgba(255,255,255,0.8)'
          ...
          <li><span style={{
            color: '#3498db',
            fontWeight: 'bold'
          }}>Blue:</span> Pumped State (Fast decay)</li>
          <li><span style={{
            color: '#ef4444',
            fontWeight: 'bold'
          }}>Red:</span> Metastable State (Slow decay)</li>
          <li><span style={{
            color: '#9ca3af',
            fontWeight: 'bold'
          }}>Gray:</span> Ground State</li>
        </ul>
        <p style={{
        fontSize: '11px',
