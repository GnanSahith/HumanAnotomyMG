...
export default function CustomWaveInterference({ onBack, title }) {
    ...
    return (
        <div style={{ width: '100%', height: '100%', position: 'relative', background: '#0a0a1a', overflow: 'hidden', color: '#fff', fontFamily: "'Inter', sans-serif" }}>
            {/* Header */}
            <div style={{
                position: 'absolute',
                top: '20px',
            ...
            <div style={{
                ...
                <h3 style={{ margin: '0 0 15px 0', fontSize: '16px', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '10px', color: '#fff', fontWeight: '600' }}>
                    Controls
                </h3>
                <button
            ...
            <div style={{
                ...
                <h3 style={{ margin: '0 0 15px 0', fontSize: '16px', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '10px', color: '#fff', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <Settings2 size={18} /> Wave Parameters
                </h3>

                {/* Wave Sources */}
                <div style={{ marginBottom: '20px' }}>
                    <label style={{ fontSize: '14px', color: '#fff', fontWeight: 500, display: 'block', marginBottom: '10px' }}>Wave Sources</label>
                ...
                <div style={{ marginBottom: '20px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '14px', marginBottom: '8px' }}>
                        ...
                        <span style={{ color: 'rgba(255,255,255,0.5)', fontFamily: 'monospace' }}>{Math.round(frequency * 100)} Hz</span>
                    </div>
                    <input
                        type="range"
                        min="0.05"
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '14px', marginBottom: '8px' }}>
                        <span style={{ fontWeight: 500 }}>Source Separation</span>
                        <span style={{ color: 'rgba(255,255,255,0.5)', fontFamily: 'monospace' }}>{separation} px</span>
                    </div>
                    <input
                        type="range"
                        min="20"
                ...
                <div style={{
                    ...
                    <p style={{ margin: '0 0 6px 0', fontWeight: '600', color: '#fff' }}>Interference Pattern</p>
