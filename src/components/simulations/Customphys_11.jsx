...
const Customphys_11Inner = () => {
    ...
    useEffect(() => {
        ...
        const ground = Bodies.rectangle(400, 520, 810, 60, { isStatic: true, render: { fillStyle: '#2E8B57' } });
    ...
    const resetSkater = () => {
        if (skaterRef.current) {
            Matter.Body.setPosition(skaterRef.current, { x: 100, y: 100 });
            Matter.Body.setVelocity(skaterRef.current, { x: 0, y: 0 });
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ position: 'relative', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 20px 25px -5px rgb(0 0 0 / 0.5)' }}>
                    <div ref={sceneRef} style={{ border: '1px solid rgba(255, 255, 255, 0.1)' }} />
            ...
            <div style={{
                ...
                <h3 style={{ textAlign: 'center', margin: 0, fontSize: '16px', fontWeight: 600, color: '#f8fafc' }}>Energy Bar Graph</h3>
                <div style={{
                    height: '320px',
                    display: 'flex',
                    alignItems: 'flex-end',
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '60px' }}>
                        <div style={{ width: '32px', height: `${Math.min(260, energy.kinetic * 5000)}px`, backgroundColor: '#2ecc71', transition: 'height 0.05s linear', borderRadius: '4px 4px 0 0', boxShadow: '0 0 10px rgba(46, 204, 113, 0.3)' }} />
                        <span style={{ marginTop: '10px', fontSize: '11px', fontWeight: '500', color: '#94a3b8' }}>Kinetic</span>
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '60px' }}>
                        <div style={{ width: '32px', height: `${Math.min(260, energy.potential * 5000)}px`, backgroundColor: '#3498db', transition: 'height 0.05s linear', borderRadius: '4px 4px 0 0', boxShadow: '0 0 10px rgba(52, 152, 219, 0.3)' }} />
                        <span style={{ marginTop: '10px', fontSize: '11px', fontWeight: '500', color: '#94a3b8' }}>Potential</span>
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '60px' }}>
                        <div style={{ width: '32px', height: `${Math.min(260, energy.total * 5000)}px`, backgroundColor: '#e67e22', transition: 'height 0.05s linear', borderRadius: '4px 4px 0 0', boxShadow: '0 0 10px rgba(230, 126, 34, 0.3)' }} />
                        <span style={{ marginTop: '10px', fontSize: '11px', fontWeight: '500', color: '#94a3b8' }}>Total</span>
                    </div>
                </div>
            </div>
        </div>
...
export default function Customphys_11({ onBack, title }) {
    return (
