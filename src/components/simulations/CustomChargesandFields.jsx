    ...
    <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', pointerEvents: 'none' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <label style={{ fontSize: '11px', color: '#94a3b8', fontWeight: '600', letterSpacing: '0.05em' }}>ADD CHARGES</label>
          <button
            onClick={() => addCharge(1)}
            style={{
              padding: '10px',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px' }}>
            ...
            <span style={{ fontWeight: '600', color: '#2ecc71' }}>{gridSize}px</span>
          </div>
          <input
            type="range"
            min="20"
        ...
        <button
          ...
          onMouseEnter={(e) => { e.currentTarget.style.background = 'rgba(255, 77, 77, 0.2)'; e.currentTarget.style.border = '1px solid rgba(255, 77, 77, 0.4)'; }}
