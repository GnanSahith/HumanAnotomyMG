...
const CustomCoulombsLawInner = () => {
  ...
  const calculateForce = () => {
    ...
    if (rM <= 0) return { force: 0, isAttractive: false };
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', pointerEvents: 'none' }}>
      ...
      <div style={{
        ...
        <canvas ref={canvasRef} width={800} height={250} style={{ borderRadius: '12px' }} />
        <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', padding: '0 20px', color: '#94a3b8', fontSize: '13px', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          <label style={{ fontSize: '11px', color: '#94a3b8', fontWeight: '600', letterSpacing: '0.05em' }}>SCALE MODE</label>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px' }}>
            ...
            <span style={{ fontWeight: '600', color: q1 > 0 ? '#ef4444' : q1 < 0 ? '#3b82f6' : '#9ca3af' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px' }}>
            ...
            <span style={{ fontWeight: '600', color: q2 > 0 ? '#ef4444' : q2 < 0 ? '#3b82f6' : '#9ca3af' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          ...
          <input
            type="range"
            min={scaleMode === 'macro' ? "1" : "30"}
            max={scaleMode === 'macro' ? "10" : "500"}
            step={scaleMode === 'macro' ? "0.1" : "5"}
            value={distance}
...
export default function CustomCoulombsLaw({ onBack, title }) {
    return (
