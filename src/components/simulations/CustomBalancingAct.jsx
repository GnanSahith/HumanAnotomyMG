...
import { Play, Pause, RotateCcw, ArrowLeft, Check, Award, Eye, EyeOff, Sparkles, HelpCircle, Columns, Info, Settings2 } from 'lucide-react';
...
// LEVEL 1: PREDICT TILT (choices: left, balance, right)
{
  ...
  answer: 'right',
  // 20 * 1.0 = 20; 15 * 1.5 = 22.5. Right is heavier (torque 22.5 vs 20)
  toolbox: []
}, {
  level: 1,
  type: 'predict',
  ...
  answer: 'left',
  // 10 * 2.0 = 20; 20 * 0.75 = 15. Left is heavier.
  toolbox: []
},
  ...
  const handleMouseDown = e => {
    ...
    for (let i = state.objects.length - 1; i >= 0; i--) {
      ...
      if (obj.state === 'beam') {
        ...
        if (rx >= slotX - obj.width / 2 && rx <= slotX + obj.width / 2 && ry >= bottomY && ry <= topY) {
          clicked = obj;
          break;
        }
      } else if (obj.state === 'ground') {
        if (mx >= obj.x - obj.width / 2 && mx <= obj.x + obj.width / 2 && my >= obj.y - obj.height / 2 && my <= obj.y + obj.height / 2) {
          clicked = obj;
          break;
        }
      }
      ...
      if (currentMode === 'game' && gamePhase === 'checking') {
        ...
        if (state.checkFrameCount >= 120) {
          ...
          if (challenge) {
            ...
            if (state.theta > 0.05) finalTilt = 'right';else if (state.theta < -0.05) finalTilt = 'left';
    ...
    overflow: 'hidden'
      ...
      zIndex: 10
        ...
        alignItems: 'center'
              ...
              <button onClick={() => resetSimulation(true)} >
      ...
      zIndex: 1
        ...
        zIndex: 1
          ...
          justifyContent: 'center'
            ...
            <canvas ref={canvasRef} width={800} height={550} onMouseDown={handleMouseDown} onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleTouchEnd} style={{
            width: '100%',
            height: '100%',
            objectFit: 'contain'
          }}  />
            ...
            borderRadius: '30px'
                ...
                <button onClick={() => setActiveCategory('bricks')}  style={{
              ...
              color: activeCategory === 'bricks' ? 'white' : '#94a3b8'
                ...
                <button onClick={() => setActiveCategory('people')}  style={{
              ...
              color: activeCategory === 'people' ? 'white' : '#94a3b8'
                ...
                <button onClick={() => setActiveCategory('mystery')}  style={{
        ...
        fontFamily: "'Inter', sans-serif"
          ...
          {currentMode !== 'game' ? <div >
            ...
            gap: '8px'
              ...
              fontWeight: 500
            }}>Pillars Support</label>
                <div style={{
              display: 'flex',
              gap: '8px'
            }}>
                  <button onClick={() => setPillarsOn(true)} style={{
                flex: 1,
                padding: '10px',
                background: pillarsOn ? 'rgba(52,152,219,0.3)' : 'rgba(255,255,255,0.05)',
                color: '#fff',
                ...
                gap: '8px'
                  ...
                  <button onClick={() => setPillarsOn(false)} style={{
                flex: 1,
                padding: '10px',
                background: !pillarsOn ? 'rgba(52,152,219,0.3)' : 'rgba(255,255,255,0.05)',
                color: '#fff',
            ...
            gap: '14px'
              ...
              gap: '12px'
                ...
                cursor: 'pointer'
                  ...
                  color: '#fff',
                  fontWeight: 500
                }}>Show Force Vectors (Gravity)</span>
                  </label>
                ...
                cursor: 'pointer'
                    ...
                    <input type="checkbox" checked={showMarks} onChange={e => setShowMarks(e.target.checked)} style={{
                  width: '18px',
                  height: '18px',
                  accentColor: '#3498db'
                }} />
                ...
                cursor: 'pointer'
                    ...
                    <input type="checkbox" checked={showLabels} onChange={e => setShowLabels(e.target.checked)} style={{
                  width: '18px',
                  height: '18px',
                  accentColor: '#3498db'
                }} />
            ...
            borderRadius: '12px'
              ...
              alignItems: 'center',
              gap: '4px'
            }}><HelpCircle size={14} /> Lab Tip</span>
                <p style={{
              margin: 0,
              color: 'rgba(255,255,255,0.6)'
            }}>Drag blocks, people, or mystery boxes from the shelf at the bottom. If dropped near the seesaw, they snap to placement ticks. Stack multiple items on top of each other at the same slot!</p>
              </div>
            </div> : (/* GAME MODE SECTION PANEL */
        <section style={{
          background: 'rgba(255,255,255,0.05)',
          border: '1px solid rgba(255,255,255,0.1)',
          backdropFilter: 'blur(12px)',
          ...
          fontFamily: "'Inter', sans-serif"
              ...
              {gameLevel === null ? (/* Level Select Screen */
          <div >
                  <div >
                  ...
                  <p >Solve these physics torque balancing puzzles to earn stars! Each correct challenge awards +2 stars.</p>

                  <div >
                    <button onClick={() => selectLevel(1)}  style={{
                padding: '16px',
                background: 'rgba(255, 255, 255, 0.05)',
                border: '1px solid rgba(255, 255, 255, 0.1)'
              }}>
                      <span >Level 1</span>
                      <span >Predict Tilt</span>
                    </button>

                    <button onClick={() => selectLevel(2)}  style={{
                padding: '16px',
                background: 'rgba(255, 255, 255, 0.05)',
                border: '1px solid rgba(255, 255, 255, 0.1)'
              }}>
                      <span >Level 2</span>
                      <span >Balance Seesaw</span>
                    </button>

                    <button onClick={() => selectLevel(3)}  style={{
                padding: '16px',
                background: 'rgba(255, 255, 255, 0.05)',
                border: '1px solid rgba(255, 255, 255, 0.1)'
              }}>
                      <span >Level 3</span>
                      <span >Mystery Mass</span>
                    </button>

                    <button onClick={() => selectLevel(4)}  style={{
                padding: '16px',
                background: 'rgba(255, 255, 255, 0.05)',
                border: '1px solid rgba(255, 255, 255, 0.1)'
              }}>
                      <span >Level 4</span>
                      <span >Complex Balance</span>
                    </button>
                  </div>
                </div>) : (/* Active Challenge display */
          <div >
                  {/* Challenge Header */}
                  <div >
                    <div>
                      <span >Level {gameLevel} — Challenge {challengeIndex + 1}</span>
                      <h3 >Torque Puzzle</h3>
                    </div>
                    <button onClick={() => setGameLevel(null)}  style={{
                padding: '6px 12px',
                borderRadius: '20px'
              }}>
                      Exit Level
                  ...
                  {getActiveChallenge()?.type === 'predict' && gamePhase === 'question' && <div >
                      <label >Make your prediction:</label>
                      <div >
                        <button onClick={() => setGamePrediction('left')}  style={{
                  ...
                  color: gamePrediction === 'left' ? '#3498db' : 'white'
                        ...
                        <button onClick={() => setGamePrediction('balance')}  style={{
                  ...
                  color: gamePrediction === 'balance' ? '#3498db' : 'white'
                        ...
                        <button onClick={() => setGamePrediction('right')}  style={{
                  ...
                  {getActiveChallenge()?.type === 'mystery' && gamePhase === 'question' && <div >
                      <label >Guess Box Mass:</label>
                      <div >
                        {getActiveChallenge()?.choices.map(choice => <button key={choice} onClick={() => setMysteryMassGuess(choice)}  style={{
                  ...
                  {gameMessage && <div className={`p-3 rounded-xl border text-xs leading-normal flex items-start gap-2 ${gamePhase === 'correct' ? 'bg-emerald-500/10 border-emerald-500/20 text-emerald-400' : gamePhase === 'incorrect' ? 'bg-red-500/10 border-red-500/20 text-red-400' : 'bg-purple-500/10 border-purple-500/20 text-purple-400'}`}>
                      {gamePhase === 'correct' && <Award size={15}  />}
                      <span>{gameMessage}</span>
                    </div>}

                  {/* Action verification buttons */}
                  <div >
                    {gamePhase === 'question' && <button onClick={handleCheckAnswer}  style={{
                ...
                boxShadow: '0 0 15px rgba(52, 152, 219, 0.3)'
                    ...
                    {gamePhase === 'checking' && <button disabled  style={{
                background: 'rgba(255,255,255,0.05)',
                border: '1px solid rgba(255,255,255,0.1)',
                backdropFilter: 'blur(12px)',
                borderRadius: '16px',
                color: 'white'
                        ...
                        <RotateCcw size={14}  /> Verifying Balance...
                      </button>}

                    {gamePhase === 'correct' && <button onClick={handleNextChallenge}  style={{
                ...
                boxShadow: '0 0 15px rgba(46, 204, 113, 0.3)'
                    ...
                    {gamePhase === 'incorrect' && <button onClick={handleTryAgain}  style={{
          ...
          borderRadius: '16px'
            ...
            <div>
              ...
              margin: '0 0 12px 0'
                ...
                fontFamily: 'monospace',
                color: '#3498db'
              }}>d</code> is the distance from the pivot, <code style={{
                fontFamily: 'monospace',
                color: '#3498db'
              }}>m</code> is the mass, and <code style={{
                fontFamily: 'monospace',
                color: '#3498db'
              }}>g</code> is gravity (9.81 m/s²).</p>
            </div>
            ...
            <div>
              ...
              <p style={{
              margin: '0 0 12px 0'
            }}>For a seesaw to remain perfectly horizontal, the sum of all counterclockwise torques on the left must equal the sum of all clockwise torques on the right.</p>
            </div>
          </div>
        </div>
      </main>
